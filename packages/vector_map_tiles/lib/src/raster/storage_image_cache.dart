...
class StorageImageCache {
  ...
  StorageImageCache(Theme theme, this.delegate, {double scale = 2.0}) {
    // Patched (open_maps): the scale is part of the key so bitmaps rendered
    // at another pixel ratio are not reused.
    themeKey = '${theme.id}-v${theme.version}-x$scale'
